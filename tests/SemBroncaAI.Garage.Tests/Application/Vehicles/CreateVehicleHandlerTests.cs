...
public sealed class CreateVehicleHandlerTests
{
    ...
    {
        var garage=new GarageEntity("Oficina","123","1199","a@b.com");var customer=new CustomerEntity(garage.Id,"Cliente","456","1188","c@d.com");var handler=new CreateVehicleHandler(new GarageRepo(garage),new CustomerRepo(customer),new VehicleRepo(true),new UnitOfWork());
