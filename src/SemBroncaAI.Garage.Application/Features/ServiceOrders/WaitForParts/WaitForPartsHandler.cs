...
namespace SemBroncaAI.Garage.Application.Features.ServiceOrders.WaitForParts;

public sealed class WaitForPartsHandler
{
    private readonly IServiceOrderRepository _repository;
    private readonly IUnitOfWork _unitOfWork;

    public WaitForPartsHandler(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        serviceOrder.WaitForParts(actorId);
