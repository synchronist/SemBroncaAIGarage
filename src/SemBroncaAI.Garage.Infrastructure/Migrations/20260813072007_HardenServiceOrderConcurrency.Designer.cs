...
namespace SemBroncaAI.Garage.Infrastructure.Migrations
{
    ...
    [Migration("20260813072007_HardenServiceOrderConcurrency")]
    partial class HardenServiceOrderConcurrency
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SemBroncaAI.Garage.Domain.Entities.ServiceOrder.ServiceOrderEstimateApprovalEntity", b =>
                {
                    ...
                    b.HasIndex("ServiceOrderId", "EstimateUpdatedAt")
                        .IsUnique()
                        .HasDatabaseName("IX_ServiceOrderEstimateApprovals_ServiceOrderId_EstimateUpdatedAt_ActivePending")
